$(document).ready(function () {
    /********************************************************** S E A R C H   H I S T O R I   P A K E T   M A S U K **********************************************************/
    // validasi inputan Add 
    $("#cari_form").validate({
        rules: {
            tgl_cari: "required",
        },
        ...
        submitHandler: submitCariPaketMasukHist,
    });

    //simpan Add 
    function submitCariPaketMasukHist() {
        ...
        $("#tabledata").DataTable({
            ...
            destroy: true,
            ajax: {
                url: base_url + "/paketmasukhist/getPaketMasuk",
                type: "GET",
                data: function () {
            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, row, meta) {
                        return (
                            ...
                            'data-target="#viewModal" data-id_paketmasuk="' +
                            data +
    ...
    /********************************************************** V I E W   H I S T O R I   P A K E T   M A S U K **********************************************************/
    // get Value Field view hisori 
        ...
        if (id_paketmasuk) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $("#penerima_fisik").text(data.penerima_fisik);
