        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <div>
                        <h5 class="card-title mb-0">Statistik Paket Masuk Harian</h5>
                    </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">List Histori Paket Masuk</h4>
                <hr>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Detail Paket Masuk</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            @include('paketmasukhist.view')
        </div>
    </div>
</div>

<script type="text/javascript" src="{{ url('custom/js/paketmasukhist.js') }}"></script>
...
function updateChart() {
    ...
    fetch(`{{ url("get-paket-stats") }}?start=${startDate}&end=${endDate}`)
