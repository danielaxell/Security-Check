...
<script src="{{ url('assets/extra-libs/DataTables/file_export/dataTables.buttons.min.js') }}"></script>
<script src="{{ url('assets/extra-libs/DataTables/file_export/buttons.flash.min.js') }}"></script>
<script src="{{ url('assets/extra-libs/DataTables/file_export/jszip.min.js') }}"></script>
<script src="{{ url('assets/extra-libs/DataTables/file_export/pdfmake.min.js') }}"></script>
<script src="{{ url('assets/extra-libs/DataTables/file_export/vfs_fonts.js') }}"></script>
<script src="{{ url('assets/extra-libs/DataTables/file_export/buttons.html5.min.js') }}"></script>
<script src="{{ url('assets/extra-libs/DataTables/file_export/buttons.print.min.js') }}"></script>
<!-- validation JS -->
<script src="{{ url('assets/libs/jquery-validation/dist/jquery.validate.min.js') }}"></script>
<!-- additional validation alphanumeric JS -->
<script src="{{ url('assets/libs/jquery-validation/dist/additional/alphanumeric.js') }}"></script>
<!-- Toastr JS -->
...
<!-- Switch JS -->
<script src="{{ url('assets/libs/bootstrap-switch/dist/js/bootstrap-switch.min.js') }}"></script>
<!-- date-range-picker -->
<script src="{{ url('assets/libs/daterangepicker/new/moment.min.js') }}"></script>
<script src="{{ url('assets/libs/daterangepicker/new/daterangepicker.min.js') }}"></script>
<!-- loading overlay -->
