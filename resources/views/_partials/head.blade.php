...
<title>Security Check Pelindo</title>
<!-- datatable css -->
...
<!-- Switch css -->
<link href="{{ url('assets/libs/bootstrap-switch/dist/css/bootstrap3/bootstrap-switch.min.css') }}" rel="stylesheet">
<!-- Daterange picker -->
<link href="{{ url('assets/libs/daterangepicker/new/daterangepicker.css') }}" rel="stylesheet">
<!-- force ukuran width select2 agar responsible -->
<style>
    .select2-container {
        width: 100% !important;
        padding: 0;
