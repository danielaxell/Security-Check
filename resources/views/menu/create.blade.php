<form id="insert_form" action="#" method="POST">
    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <code>*</code>
            <input type="number" name="urutan" min=1 class="form-control" placeholder="Masukkan Urutan" required>
        ...
        <div class="form-group">
            ...
            <code>*</code>
            <input type="text" name="url" class="form-control" placeholder="Masukkan Nama Url">
            <code>(dikosongi untuk parent menu)</code>
        </div>
        <div class="form-group">
