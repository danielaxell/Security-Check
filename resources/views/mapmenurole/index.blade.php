    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h4 class="float-left"> List Mapping Menu - Role </h4>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Tambah Mapping Menu - Role</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            @include('mapmenurole.create')
        </div>
        <!-- /.modal-content -->
    </div>
    <!-- /.modal-dialog -->
...
<div class="modal fade" id="editModal">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Edit Mapping Menu - Role</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            @include('mapmenurole.edit')
        </div>
        <!-- /.modal-content -->
    </div>
    <!-- /.modal-dialog -->
...
<div class="modal fade" id="deleteModal">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Delete Data Menu - Role </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form id="delete_form" action="#" method="POST">
                ...
                <div class="modal-body">
                    <p>Apakah Anda yakin ingin menghapus menu role ini?</p>
                ...
                <div class="modal-footer">
                    <input type="hidden" name="id_menu_role" class="id_menu_role">
...
<script type="text/javascript" src="{{ url('custom/js/mapmenurole.js') }}"></script>
