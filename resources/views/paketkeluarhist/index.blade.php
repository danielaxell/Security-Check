        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <div>
                        <h5 class="card-title mb-0">Statistik Paket Keluar Harian</h5>
                    </div>
                ...
                <div style="height: 230px;">
                    <canvas id="paketKeluarChart"></canvas>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript" src="{{ url('custom/js/paketkeluarhist.js') }}"></script>

@push('scripts')
<script src="https://cdn.jsdelivr.net/npm/chart.js@2.9.4"></script>
<script>
let paketKeluarChart = null;
...
function updateChart() {
    ...
    fetch(`{{ url("get-paketkeluar-stats") }}?start=${startDate}&end=${endDate}`)
        .then(response => response.json())
        .then(data => {
            if (paketKeluarChart) {
                paketKeluarChart.destroy();
            }
            ...
            const ctx = document.getElementById('paketKeluarChart').getContext('2d');
            paketKeluarChart = new Chart(ctx, {
                type: 'bar',
                data: {
                    ...
                    datasets: [{
                        label: 'Jumlah Paket',
                        data: data.values,
                        backgroundColor: 'rgba(40, 167, 69, 0.6)', // Warna hijau untuk paket keluar
                    ...
                    tooltips: {
                        ...
                        callbacks: {
                            label: function(tooltipItem) {
                                return tooltipItem.value + ' Paket';
                            }
                        }
                    },
                    legend: {
