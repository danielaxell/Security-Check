            ...
            <ul id="sidebarnav">
                ...
                <li>
                    ...
                    <div class="user-profile dropdown m-t-20">
                        <div class="user-pic">
                            <img src="/assets/images/users/user.jpg" alt="users" class="rounded-circle img-fluid" />
                        </div>
                        <div class="user-content hide-menu m-t-10">
                            <h5 class="m-b-10 user-name font-medium">{{ request()->session()->get('nama') }} | {{
                                request()->session()->get('kd_divisi') }}</h5>
                            <a href="auth/logout" title="Logout" class="btn btn-circle btn-sm">
